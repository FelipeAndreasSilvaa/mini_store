...
const Produtos = React.forwardRef(() => {



  return (
   <>
    <div id='mobile_products' className="text-center p-10">
        <h1 className="font-bold text-4xl mb-4">Mobile Products</h1>
    </div>
    <section id="Projects" className="w-fit  mx-auto grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-5 mb-5">
    ...
    <div id="watches_apple" className="text-center p-10">
        <h1 className="font-bold text-4xl mb-4">Apple Watchs</h1>
    </div>
    <section className="w-fit  mx-auto grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-5 mb-5">
        <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
            <a href="#">
                <img src="https://images.unsplash.com/photo-1646753522408-077ef9839300?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8NjZ8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
                        alt="Product" className="h-80 w-72 object-cover rounded-t-xl" />
    ...
    <div className="text-center p-10">
        <h1 className="font-bold text-4xl mb-4">Latest Post</h1>
    </div>
    <section id="Projects" className="w-fit  mx-auto grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-5 mb-5">
        <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
            <a href="#">
